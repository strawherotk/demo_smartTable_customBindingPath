sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/hq/test/EmployeeList_northWind/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.hq.test.EmployeeList_northWind.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/hq/test/EmployeeList_northWind/localService/mockserver"], function (mockserver) {
